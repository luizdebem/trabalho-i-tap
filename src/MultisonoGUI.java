...
public class MultisonoGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem5.setText("Listar lógico");
        jMenu2.add(jMenuItem5);

        jMenuItem6.setText("Listar físico");
        ...
        jMenuItem7.setText("Tamanho do Arquivo (bytes)");
        jMenu3.add(jMenuItem7);

        jMenuItem8.setText("Quantidade de Registros");
        jMenu3.add(jMenuItem8);

        jMenuItem9.setText("Esvaziar arquivo");
